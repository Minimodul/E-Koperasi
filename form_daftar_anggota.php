    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Form Pendaftaran Anggota Baru</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="ID Member" name=id>
                                        </div>

                                        <div class="form-group">
                                            <label>Kartu Tanda Penduduk</label>
                                            <input class="form-control" placeholder="Kartu Tanda Penduduk" name=ktp>
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <input class="form-control"  placeholder="Tempat Lahir" name=tmpt_lahir>
                                            
                                        </div>
                                        <div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                                                <input class="form-control"   placeholder="Tanggal Lahir" type="text" name="tgl_lahir" readonly="readonly">
