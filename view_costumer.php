                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                    $sql=mysql_query("SELECT id,ktp, nama, jk, tmpt_lahir, tgl_lahir, wn, pekerjaan, alamat, email, notelp FROM costumer ORDER BY ktp");
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        ...
                                        <td><?php echo $r["jk"]?></td>
                                        <td><?php echo $r["tmpt_lahir"]?>, <?php echo $r["tgl_lahir"]?></td>
                                        <td><?php echo $r["wn"]?></td>
                                        <td><?php echo $r["pekerjaan"]?></td>
                                        <td><?php echo $r["alamat"]?></td>
                                        <td><?php echo $r["email"]?></td>
                                        <td><?php echo $r["notelp"]?></td>
                                        <td><a href="edit_anggota.php?id=<?php echo $r["id"]; ?>"><i class="fa fa-edit fa-fw"></i></a>
                                            <a href="delete_costumer.php?id=<?php echo $r["id"]; ?>"><i class="fa fa-times fa-fw"></i></a>
                                    </tr>
