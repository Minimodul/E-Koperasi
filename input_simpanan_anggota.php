...
<?php
  ...
  $carikode = mysql_query("select max(kode_simpan) from simpan_dana") or die (mysql_error());
  // menjadikannya array
  ...
  $jns_simpan = $_POST['jns_simpan'];
    $sql  = "INSERT INTO simpan_dana (kode_simpan,
                                 id,
                                 tgl_transaksi,
                                 nominal,
                                 jns_simpan) 
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Status Simpanan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <div class="col-lg-6" class="center">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="form_simpanan_anggota.php"><button type="submit" class="btn btn-primary" >Next >></button></a>
