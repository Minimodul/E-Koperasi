...
<body>
    <?php 
        include"koneksi.php";
        echo"   <center></center>
        <form method=post action=hasil_simpan.php>";
    ?>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Report Simpan ID Member :</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="form-group" class="col-lg-6">
                                <div class="form-group input-group">
                                    ...
                                    <span class="input-group-addon"><button type="submit" name="submit" id="submit" class="btn btn-default btn-xs"><i class="fa fa-search fa-fw"></i></button></span>
                                </div>
                             </div>
                        </div>
                        <!-- /.panel-heading -->
