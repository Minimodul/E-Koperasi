                    ...
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            <?php
                                ...
                                $q = "SELECT * from simpan_dana where id like '%$id%' ";
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <?php
                                $id= $_POST['id']; //get the nama value from form
                                $q = "SELECT * from simpan_dana where id like '%$id%' "; //query to get the search result
                                $result = mysql_query($q); //execute the query $q
                                while ($r = mysql_fetch_array($result)) {
                                    ?>
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td><?php echo $r["kode_simpan"]; ?></td>
                                        <td><?php echo $r["id"]; ?></td>
                                        <td><?php echo $r["tgl_transaksi"]; ?></td>
                                        <td><?php echo $r["nominal"]; ?></td>
                                        <td><?php echo $r["jns_simpan"]; ?></td>
                                    </tr>
