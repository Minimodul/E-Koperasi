...
include"koneksi.php";
echo"   <center></center>
        <form method=post action=input_simpanan_anggota.php>";
        ?>
    <div id="wrapper">
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
                                        <div class="form-group">
                                            <input type=hidden class="form-control" name=kode_simpan>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="form-group input-group">
                                                    ...
                                                    <input type=text class="form-control" name=nominal size=52 onFocus="startCalc();" onBlur="stopCalc();">
